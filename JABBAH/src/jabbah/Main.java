...
Hierarchical Task Networks Planning domains.
    ...
    bajo los t閞minos de la Academic Free License ("AFL") v. 3.0).
    ...
    Deber韆 haber recibido una copia de la Academic Free License ("AFL") v. 3.0
...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("Log Output", logPanel);
 ...
 // a method to build our example graph g from the Absolute Path to XPDL file
                                    ...
                                    String AbsolutePath)
    {
        try {
            ...
            try {
                ...
                logger.log(Level.SEVERE, "Ocurri贸 una excepci贸n al parsear el XPDL", ex);
            } catch (XPathExpressionException ex) {
                logger.log(Level.SEVERE, "Ocurri贸 un error con XPATH al parsear el XPDL", ex);
            } catch (IOException ex) {
                logger.log(Level.SEVERE, "Ocurri贸 una excepci贸n de I/O al parsear el XPDL", ex);
            } catch (ParserConfigurationException ex) {
                logger.log(Level.SEVERE, "Ocurri贸 una excepci贸n de configuraci贸n de " +
        ...
        if (xom.Activities.length==0)
            logger.severe ("El n煤mero de actividades es CERO en el m茅todo buildGraphFromXPDL()");
            ...
            Activity[] activities, Transition[] transitions, String l, XpdlObjectMapping xom)
    {
        ...
        for (int i=0; i<activities.length; i++)
        {
            if (activities[i].type == NodeType.SUBPROCESS)
            {
                ...
                // de 茅l mismo, creando un 煤nico grafo
    ...
    public void init(String AbsolutePath)
    {
        ...
        try {
            String logfile = System.getProperty("java.io.tmpdir") + "/jabbah.log";
            this.jTextPane3.read(new FileInputStream(logfile), null);
        } catch (IOException ex) {
            Logger.getLogger(Main.class.getName()).log(Level.SEVERE, null, ex);
        }
